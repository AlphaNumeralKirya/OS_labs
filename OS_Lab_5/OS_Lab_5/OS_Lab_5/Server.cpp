...
int main(int argc, char* argv[])
{
	...
	HANDLE R = CreateEvent(NULL, FALSE, FALSE, (LPCSTR)"R");
	HANDLE SR = CreateEvent(NULL, FALSE, FALSE, (LPCSTR)"SR");
	...
	wsprintf(lpszComLine, (LPCSTR)"C:\\Users\\kirya\\source\\repos\\OS_Lab_5\\Debug\\OS_Lab_5(Simple).exe %d %d", (int)hWritePipe, (int)hReadPipe);
